...
export function generateDemoData() {
  ...
  return { schoolYears: [schoolYear], levels, classes, students, teachers: teachers.map((t) => ({ ...t })), competencies, evaluations, skillRecoveryActions: [], skillRecoveryRequests: [], alerts, notifications };
}
